    ...
    try {
      ...
      const data = await axios
        ...
        .then((data) => {
          ...
          setsuccessfull("User Updated Successfully");
        ...
        .catch((err) => {
          setError(true);
          seterrormessage("User Already Exist with these credentials");
          setsuccessfull("");
          setLoading(false);
        });
    } catch (error) {
  ...
  return (
    <div>
      ...
      <Card className="p-3">
        ...
        <h4 className="main-heading mb-3">UPDATE USER</h4>
